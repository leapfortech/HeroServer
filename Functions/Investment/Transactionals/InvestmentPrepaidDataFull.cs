...
{
    public class InvestmentPrepaidDataFull
    {
        ...
        public InvestmentPrepaidDataFull()
        {
        }

        public InvestmentPrepaidDataFull(List<InvestmentPrepaidFull> investmentPrepaidFulls,
