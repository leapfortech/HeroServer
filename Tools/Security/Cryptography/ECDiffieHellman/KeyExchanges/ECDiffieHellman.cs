...
namespace MLAPI.Cryptography.KeyExchanges
{
    ...
    {
        protected static readonly RandomNumberGenerator rndGen = RandomNumberGenerator.Create();
        ...
        public static readonly CurvePoint DEFAULT_GENERATOR = new CurvePoint(9, new BigInteger("14781619447589544791020593568409986887264606134616475288964881837755586237401"));
        ...
        public ECDiffieHellman(EllipticCurve curve, CurvePoint generator, BigInteger order, byte[] priv = null)
        {
            ...
            if (priv == null)
            {
                ...
                this.priv.GenRandomBits(order.dataLength * 8, rndGen);
            }
            else
