...
namespace HeroServer
{
    public class ProductReviewDB
    {
        ...
        public async Task<List<long>> GetProductReviewIdsByProductId(long productId, int status = -1)
        {
            String strCmd = $"SELECT Id FROM {table} WHERE ProductId = @ProductId";
        ...
        public async Task<bool> DeleteByProductId(long productId)
        {
