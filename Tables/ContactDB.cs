...
namespace HeroServer
{
    public class ContactDB
    {
        ...
        public async Task<long> Add(Contact contact)
        {
            ...
            command.AddParam("@PostId", SqlDbType.BigInt, contact.PostId);
            command.AddParam("@Name", SqlDbType.VarChar, contact.Name);
            ...
            command.AddParam("@Status", SqlDbType.Int, contact.Status);
        ...
        public async Task<bool> Update(Contact contact)
        {
            ...
            command.AddParam("@UpdateDateTime", SqlDbType.DateTime, DateTime.Now);
            command.AddParam("@Status", SqlDbType.Int, contact.Status);
            command.AddParam("@Id", SqlDbType.BigInt, contact.Id);
