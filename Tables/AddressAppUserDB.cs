...
namespace HeroServer
{
    public class AddressAppUserDB
    {
        ...
        public async Task<long> Add(AddressAppUser addressAppUser)
        {
            ...
            command.AddParam("@AppUserId", SqlDbType.BigInt, addressAppUser.AppUserId);
            command.AddParam("@AddressId", SqlDbType.BigInt, addressAppUser.AddressId);
            ...
            command.AddParam("@Status", SqlDbType.Int, addressAppUser.Status);
        ...
        public async Task<bool> Update(AddressAppUser addressAppUser)
        {
            ...
            command.AddParam("@AddressId", SqlDbType.BigInt, addressAppUser.AddressId);
            command.AddParam("@UpdateDateTime", SqlDbType.DateTime2, DateTime.Now);
            command.AddParam("@Id", SqlDbType.Int, addressAppUser.Id);
